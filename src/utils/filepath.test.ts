...
Deno.test("[replaceExt]", () => {
  asserts.assertEquals(
    replaceExt("foo/bar.html", "_content.js"),
    "foo/bar_content.js",
  );
});
Deno.test("[getOutputPath]", () => {
  ...
  asserts.assertEquals(
    getOutputPath("foo/bar/README.md"),
    "foo/bar/index.html",
  );
...
Deno.test("[replaceLink]", () => {
  ...
  asserts.assertEquals(
    replaceLink("README.md?foo=bar#hello"),
    "index.html?foo=bar#hello",
  );
  ...
  asserts.assertEquals(
    replaceLink("foo/bar/README.md?foo=bar"),
    "foo/bar/index.html?foo=bar",
  );
  asserts.assertEquals(
    replaceLink("foo/bar/README.md#hello"),
    "foo/bar/index.html#hello",
  );
  asserts.assertEquals(
    replaceLink("foo/bar/README.md?foo=bar#hello"),
    "foo/bar/index.html?foo=bar#hello",
  );
...
Deno.test("[findNearestLayoutPath]", () => {
  asserts.assertEquals(
    findNearestLayoutPath("baz.md", ["foo/_layout.tsx", "_layout.tsx"]),
    "_layout.tsx",
  );
  asserts.assertEquals(
    findNearestLayoutPath("bar/baz.md", ["foo/_layout.tsx", "_layout.tsx"]),
    "_layout.tsx",
  );
  asserts.assertEquals(
    findNearestLayoutPath("foo/bar/baz.md", ["foo/_layout.tsx", "_layout.tsx"]),
    "foo/_layout.tsx",
  );
  asserts.assertEquals(
    findNearestLayoutPath("bar/baz.md", ["bar/_layout.tsx", "_layout.tsx"]),
    "bar/_layout.tsx",
  );
});
